Ext.onReady(function () {
    ...
    var record = new Ext.data.Record.create([
        ...
        //{name: 'lardlord', mapping: 'lardlord'},
        //{name: 'lardlord_idcard', mapping: 'lardlord_idcard'},
        //{name: 'lardlord_attention', mapping: 'lardlord_attention'},
        //{name: 'lardlord_type', mapping: 'lardlord_type'},
    ...
    var proxy = new Ext.data.HttpProxy({
        url: "../../CommunityDoorplateAction_find.action"
    });
        ...
        Ext.Ajax.request({
            ...
            success: function(response){
                ...
                for(var i = 0; i < total; i ++) {
                    ...
                    userPanelsun.add(new Ext.form.DisplayField({ id:'type.info' + row.id , fieldLabel:'类型',value:show_status_lardlord(row.status) }));
...
function show_status_lardlord(status){
    if (status == "1") {
        return '<span style="color:red;">当前房东</span>';
    } else {
        return '<span style="color:green;">以前房东</span>';
    }
}
