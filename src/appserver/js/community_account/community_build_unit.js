Ext.onReady(function () {
    ...
    var proxy = new Ext.data.HttpProxy({
        url: "../../CommunityBuildUnitAction_findByAccount.action"
    });
    ...
    var colM = new Ext.grid.ColumnModel([
        ...
        {header: "小区楼栋", dataIndex: "community_build_value", align: 'center', sortable: true, menuDisabled: true,renderer:show_build_z},
        {header: "小区单元", dataIndex: "value", align: 'center', sortable: true, menuDisabled: true,renderer:show_unit_z},
...
function viewInfo() {
    ...
    var formPanel = new Ext.form.FormPanel({
        ...
        items: [
            ...
            new Ext.form.DisplayField({
                fieldLabel: '楼栋单元号',
                value: show_build_z(recode.get("community_build_value")) + show_unit_z(recode.get("value"))
            }),
            new Ext.form.DisplayField({
                fieldLabel: '单元负责人',
                ...
                listeners:{
                    blur:function(){
                        ...
                        if(unit.length>0){
                            ...
                            myMask.show();
                            Ext.Ajax.request({
                                url: '../../CommunityBuildUnitAction_checkByAccount.action',
