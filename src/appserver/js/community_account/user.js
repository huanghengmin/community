...
*/
    ...
    var proxy = new Ext.data.HttpProxy({
        url: "../../UserAction_findByAccount.action"
    });
    ...
    var colM = new Ext.grid.ColumnModel([
        //boxM,
        rowNumber,
        {header: "用户名(手机号)", dataIndex: "phone", align: 'center', sortable: true, menuDisabled: true},
...
//                            : Ext.getCmp('number.tb.info').getValue();
                        ...
                        var phone = Ext.fly("phone.tb.info").dom.value == '请输入用户名(手机号)'
                            ? null
                            : Ext.getCmp('phone.tb.info').getValue();
