Ext.onReady(function () {
    ...
    var proxy = new Ext.data.HttpProxy({
        url: "../../CommunityDoorplateAction_findPersonByAccount.action?type=1"
    });
...
//        {header: "工号", dataIndex: "number", align: 'center', sortable: true, menuDisabled: true},
        ...
        {header: "类型", dataIndex: "type", align: 'center', sortable: true, menuDisabled: true,renderer:show_type},
...
function show_build_unit(value,o,r) {
    return value + '幢' + r.get('community_build_unit') + '室';
