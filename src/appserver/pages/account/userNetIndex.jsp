...
<html version="-//W3C//DTD HTML 4.01 Transitional//EN">
    <head>
		...
		<script type="text/javascript" src="${pageContext.request.contextPath}/js/user/community_doorplate.js"></script>
    </head>
...
<head>
    ...
    <script type="text/javascript" src="${pageContext.request.contextPath}/js/account/userNetIndex.js"></script>
</head>
